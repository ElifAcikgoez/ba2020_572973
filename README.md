...
Es kann zu jedem einzelnen todo eine Notiz beigelegt werden. Dazu einfach erst ein todo zur Liste hinzufügen und dann über dem todo-text auf den "Notiz" Button klicken. Danach die gewünschte Notiz in das textfeld eingeben und auf den "Bestätigen" Button klicken. Wenn man die Notiz umbennen möchte, einfach nochmal auf den button klicken und die neue Notiz eingeben.
